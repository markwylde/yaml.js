...
Parser = (function() {
  ...
  Parser.prototype.PATTERN_LEADING_COMMENTS = new Pattern('^\w*(\\#.*?\n)+');
  ...
  Parser.prototype.parse = function(value, exceptionOnInvalidType, objectDecoder) {
    ...
    while (this.moveToNextLine()) {
      ...
      if (values = this.PATTERN_SEQUENCE_ITEM.exec(this.currentLine)) {
        ...
        if (!(values.value != null) || '' === Utils.trim(values.value, ' ') || Utils.ltrim(values.value, ' ').indexOf('#') === 0) {
          ...
          if (((ref = values.leadspaces) != null ? ref.length : void 0) && (matches = this.PATTERN_COMPACT_NOTATION.exec(values.value))) {
            ...
            var parsed = this.parseValue(values.value, exceptionOnInvalidType, objectDecoder)
            this.setLineNumber(parsed, this.offset + 1)
            data.push(parsed);
          }
        }
      ...
      this.setLineNumber(data, this.offset + 1)
  ...
  var LineNumberFuncName = "getLineNumber"
  Parser.prototype.setLineNumber = function(obj, val) {
      if (obj[LineNumberFuncName] !== undefined) return;    
      if (obj.constructor === Object ||
          obj.constructor === String) {
        Object.defineProperty(obj, LineNumberFuncName, { value: function () { return val } })
      }     
  }
  ...
  Parser.prototype.parseValue = function(value, exceptionOnInvalidType, objectDecoder) {
    ...
    try {
      var parsed = Inline.parse(value, exceptionOnInvalidType, objectDecoder);
      return parsed;
    } catch (error) {
      e = error;
